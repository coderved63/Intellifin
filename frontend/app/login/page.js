            ...
            <div className="max-w-md w-full relative z-10 px-6">
                <div className="bg-[#0a0a0a] p-10 rounded-[32px] shadow-2xl border border-white/5 space-y-8">
                    <div className="text-center space-y-3">
                        ...
                        <h2 className="text-3xl font-bold text-white tracking-tight">Intelligence Vault</h2>
                        <p className="text-slate-500 text-xs font-bold uppercase tracking-[0.2em]">Secure Access Required</p>
                    </div>
                    ...
                    <div className="pt-6 border-t border-white/5 text-center">
                        <p className="text-slate-500 text-xs font-medium">
                            First time here? <Link href="/signup" className="text-indigo-400 font-bold hover:text-indigo-300 transition-colors ml-1">Create an Identity</Link>
                        </p>
                    </div>
                </div>
